...
public class RefreshRecycleView extends SwipeRefreshLayout {
     ...
     * 设置加载更多监听
     *
     * @param listener {@link RefreshRecycleView.OnLoadMoreListener}
     */
    ...
    private class LoadMoreRecyclerView extends RecyclerView {
        ...
        public void onScrollStateChanged(int state) {
            ...
            if (state == SCROLL_STATE_IDLE && // 停止滚动
                    loadMoreEnable && refreshView.mOnLoadMoreListener != null && // 可以加载更多, 且有加载监听
     ...
     */
    public static abstract class RefreshAdapter<VH extends ViewHolder> extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if (viewType == TYPE_CONTENT || viewTypes.contains(viewType)) {
                onBindHolder((VH) holder, refreshView.header != null ? position - 1 : position);
            }
        }
